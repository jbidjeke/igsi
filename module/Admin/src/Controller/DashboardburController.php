...
class DashboardburController extends BaseController
{
    ...
    public function __construct(AdapterInterface $db, MyLogApplicatif $log, DbTable\HistoriqueModifications $histo, CalculEvolutionIgBur $calculEvolutionIg, CalculDate $calculDate, DbTable\TicketControl $ticketControl, DbTable\MessageDashboard $messageDashboard, DbTable\Message $message, OthersIg $othersIg, Pilote $pilote, IgDashboard $igDashboard)
    {
        $this->db = $db;
        $this->log = $log;
        $this->histo = $histo;
