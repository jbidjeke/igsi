...
class PermissionManager
{
    ...
    public function addPermission($data)
    {
        ...
        $permission->setDescription(utf8_encode($data['description']));
    ...
    public function createDefaultPermissionsIfNotExist()
    {
        ...
        $defaultPermissions = [
            'admin.manage' => 'Super administrateur',
            'user.manage' => 'Administrateur',
            'pilote.manage' => 'Valider les actions, etc.',
            'ls.manage' => 'Soumettre, etc.',
            'permission.manage' => 'Gestion de permissions',
            'role.manage' => 'Gestion de profil',
            'profile.any.view' => 'Voir le profil de n\'importe qui',
            'profile.own.view' => 'Voir son propre profil',  
        ];
