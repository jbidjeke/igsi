...
use Aui\Service\LdapLogin as ldapAdapter;
...
class AuthManager
{
     ...
     */
    public function __construct($authService, $sessionManager, $config, $rbacManager, $ldapAdapter) 
    {
     ...
     */
    public function login($full_name, $password, $rememberMe)
    {   
        $identity = $this->authService->getIdentity();
        ...
        */
        ...
        $authAdapter->setEmail($full_name);
        ...
        if ($result->getCode() != Result::SUCCESS) { 
            ...
            $adapter = $this->ldapAdapter;
            $adapter->setUsername($full_name);
