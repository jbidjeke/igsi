...
return [
    ...
    'access_filter' => [
        'controllers' => [
            \Application\Controller\BaseController::class => [
            ...
            \Admin\Controller\AdminController::class => [
                ...
                //['actions' => ['matrice', 'insertmatricestd', 'logdashboard'], 'allow' => '+pilote.manage'],
            ],
            \Calcul\Controller\CalculController::class => [
                // Give access to "Calcul"
                // to user.manage and pilote.manage
                ['actions' => '*', 'allow' => '+ls.manage'],
                
                // Give access to 'index', 'calculer', 'insert' actions to users having the "user.manage" permission.
             ],

            \Calcul\Controller\CalculburController::class => [
                // Give access to "Calcul"
                // to user.manage and pilote.manage
                ['actions' => '*', 'allow' => '+ls.manage'],
            ...
            \Requeter\Controller\RequeterController::class => [
                // Give access to "Requeter" 
                // to anyone.
                ['actions' => '*', 'allow' => '*'],
                
                // Give access to "getplatinium", "getor", "getargent", "getbronze",  "downloadxls", "igsixmonths" actions to users having the "user.manage" permission.
             ],
            \Documentation\Controller\DocumentationController::class => [
                // Give access to "Requeter"
                // to anyone.
                ['actions' => '*', 'allow' => '*'],
                // Give access to "getplatinium", "getor", "getargent", "getbronze",  "downloadxls", "igsixmonths" actions to users having the "user.manage" permission.
            ...
            \Admin\Controller\DashboardController::class => [
                ...
                // to anyone.
                ['actions' => ['index', 'murimage', 'dashboards', 'igdumois'], 'allow' => '*'],
                ['actions' => ['index', 'updatemessage', 'insertpilote', 'message', 'pilote'], 'allow' => '+pilote.manage'],
                ['actions' => '*', 'allow' => '+user.manage']
            ],

            \Admin\Controller\DashboardburController::class => [
                // Give access to "Dashboard bur"
                // to anyone.
                ['actions' => ['index', 'murimage', 'dashboards', 'igdumois'], 'allow' => '*'],
                ['actions' => ['index', 'updatemessage', 'insertpilote', 'message', 'pilote'], 'allow' => '+pilote.manage'],
                ['actions' => '*', 'allow' => '+user.manage']
            ],
            \Esms\Controller\SiController::class => [
                // Give access to "Dashboard"
                // to anyone.
                ['actions' => '*', 'allow' => '+ls.manage'],
            ],
            Controller\UserController::class => [
                ...
                ['actions' => ['index', 'add', 'edit', 'view', 'changePassword', 'delete'], 'allow' => '+user.manage'],
